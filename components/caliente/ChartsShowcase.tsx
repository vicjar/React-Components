    ...
    <CCard title="Bar Chart" subtitle="Monthly revenue by game type ($K)">
      <CChart
        ...
        option={{
          ...
          legend: {
            data: ["Slots", "Poker", "Blackjack", "Roulette"],
            bottom: 0,
          ...
          yAxis: {
            type: "value",
            axisLabel: { color: "#6B6B6B", formatter: "${value}K" },
          ...
          series: [
            {
              ...
              type: "line",
              smooth: true,
              data: [120, 132, 101, 134, 90, 230, 210, 182, 191, 234, 290, 330, 310, 280, 320, 350, 310, 290, 380, 410, 390, 420, 440, 460, 430, 410, 490, 520, 500, 530],
            ...
            },
            {
              ...
              type: "line",
              smooth: true,
              data: [520, 580, 610, 590, 640, 720, 690, 750, 810, 780, 820, 860, 830, 800, 850, 890, 920, 880, 940, 980, 950, 1020, 990, 1050, 1080, 1020, 1100, 1150, 1120, 1180],
              areaStyle: { opacity: 0.1 },
              lineStyle: { width: 2 },
            },
            {
              ...
              type: "line",
              smooth: true,
              data: [80, 90, 70, 110, 100, 120, 140, 130, 150, 160, 140, 180, 170, 190, 200, 210, 190, 220, 230, 250, 240, 260, 280, 270, 300, 290, 310, 330, 320, 350],
              areaStyle: { opacity: 0.1 },
              lineStyle: { width: 2 },
            },
          ],
    ...
    <CCard title="Stacked Line Chart" subtitle="Cumulative game revenue by month ($K)">
      <CChart
        ...
        option={{
          ...
          legend: {
            data: ["Slots", "Poker", "Blackjack", "Roulette", "Baccarat"],
            bottom: 0,
            textStyle: { color: "#6B6B6B" },
          },
          grid: { left: "3%", right: "4%", bottom: "14%", top: "8%", containLabel: true },
...
function ScatterChartExample() {
  const generateData = (count: number, maxBet: number, factor: number) =>
    ...
    <CCard title="Scatter Chart" subtitle="Player bet amounts vs. winnings correlation">
      <CChart
        ...
        option={{
          ...
          legend: {
            data: ["VIP Players", "Regular Players"],
            bottom: 0,
            textStyle: { color: "#6B6B6B" },
          },
          grid: { left: "3%", right: "4%", bottom: "14%", top: "8%", containLabel: true },
          ...
          series: [
            {
              ...
              type: "scatter",
              symbolSize: 10,
              data: generateData(40, 5000, 1.2),
              itemStyle: { color: CALIENTE_CHART_COLORS[0], opacity: 0.7 },
            },
            {
              name: "Regular Players",
              type: "scatter",
              symbolSize: 8,
              data: generateData(60, 1000, 0.8),
              itemStyle: { color: CALIENTE_CHART_COLORS[2], opacity: 0.7 },
            },
          ],
        }}
      />
...
function BubbleChartExample() {
  // [x: avg bet, y: avg session min, size: player count]
  const games = [
      ...
      <CChart
        ...
        option={{
          ...
          series: games.map((g, i) => ({
            ...
            data: g.data,
            symbolSize: (val: number[]) => Math.sqrt(val[2]) / 1.5,
          ...
          series: [
            {
              ...
              data: [
                {
                  value: [92, 88, 75, 60, 85, 78],
                  name: "Slots",
                  areaStyle: { opacity: 0.15 },
                  lineStyle: { width: 2 },
                },
                {
                  value: [70, 55, 85, 90, 60, 88],
                  name: "Poker",
                  areaStyle: { opacity: 0.15 },
                  lineStyle: { width: 2 },
                },
                {
                  value: [80, 72, 80, 70, 75, 82],
                  name: "Blackjack",
                  areaStyle: { opacity: 0.15 },
                  lineStyle: { width: 2 },
                },
